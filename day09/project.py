...
if __name__ == "main":
    ...
    keru = AccountFactory.create("savings", "Keru", 3000, 700)
    biruk = AccountFactory.create("current", "Biruk", 4000, 800)
    abebe = AccountFactory.create("basic", "Abebe", 5000, 500)

    for account in [keru, biruk, abebe]:
    ...
    branchA.add_account(keru)
    branchA.add_account(biruk)
    region1.add_account(abebe)
